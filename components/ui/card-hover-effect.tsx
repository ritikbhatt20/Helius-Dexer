...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl h-full w-full p-4 overflow-hidden bg-black border border-helius-orange/50 dark:border-helius-orange group-hover:border-helius-orange relative z-20",
        className
      )}
    >
